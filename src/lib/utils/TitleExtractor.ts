...
export function getTitle(
  ...
  const preferred = titles.find(t => t.type.toLowerCase() === preferredType.toLowerCase());
  if (preferred?.title) {
  ...
  if (preferredType === "English") {
    ...
    const japaneseTitle = titles.find(t => t.type.toLowerCase() === "japanese");
    ...
    const englishTitle = titles.find(t => t.type.toLowerCase() === "english");
